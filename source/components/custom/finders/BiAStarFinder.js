...
import {DiagonalMovement, Util, Heuristic} from '../'
...
class BiAStarFinder{
    ...
    findPath(startX, startY, endX, endY, grid) {
        const cmp = function (nodeA, nodeB) {
                return nodeA.f - nodeB.f
            }
        let startOpenList = new Heap(cmp)
        let endOpenList = new Heap(cmp)
